...
/**
 * @apiNote Home page configuration items
 * 1-Search box hot search
 * 2-Search drop-down box hot search
 * 3- (Home page) Hot products
 * 4- (Home page) New products are available
 * 5- (Home page) Recommended for you
 */
