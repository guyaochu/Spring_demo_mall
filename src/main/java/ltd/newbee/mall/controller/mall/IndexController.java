...
public class IndexController {
    ...
    public String indexPage(HttpServletRequest request) {
        ...
        request.setAttribute("carousels", carousels);//Carousel
        request.setAttribute("hotGoodses", hotGoodses);//Hot products
        request.setAttribute("newGoodses", newGoodses);//New product
